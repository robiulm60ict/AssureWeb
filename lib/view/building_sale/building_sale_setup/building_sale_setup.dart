    ...
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: SingleChildScrollView(
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Building Total Amount ${widget.model.totalCost
                        .toString()}",
                  ...
                  Obx(
                        () =>
                        Text(
                          "Booking & Down Payment Amount ${buildingSaleController
            ...
            Container(
              width: double.infinity,
              height: Responsive.isMobile(context) ? AppDefaults.height(
                  context) * 0.1 : AppDefaults.height(context) * 0.2,
              padding: EdgeInsets.symmetric(
                vertical: AppDefaults.padding *
                    (Responsive.isMobile(context) ? 1 : 0.5),
                horizontal: AppDefaults.padding *
                  ...
                  child: DataTable(
                    ...
                    rows: List<DataRow>.generate(
                      buildingSaleController.installmentPlan.length,
                        ...
                        return DataRow(
                          cells: <DataCell>[
                            DataCell(Text('${installment['id']} Installment')),
